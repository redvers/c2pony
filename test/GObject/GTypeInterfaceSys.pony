...
*/
/* 
fun get_plugin(instance_type': U64, interface_type': U64): Pointer[GTypePluginT] =>
    @g_type_interface_get_plugin(instance_type', interface_type')
*/
/* 
fun peek(instance_class': Pointer[None] tag, iface_type': U64): Pointer[None] =>
    @g_type_interface_peek(instance_class', iface_type')
*/
/* 
fun prerequisites(interface_type': U64, n_prerequisites': Pointer[U32] tag): Pointer[U64] =>
...
// Methods
/* 
fun g_type_interface_peek_parent(g_iface': Pointer[None] tag): Pointer[None] =>
