...
// use @g_value_dup_boxed[Pointer[None]](value': NullablePointer[GValueT])
// use @g_value_dup_object[Pointer[None]](value': NullablePointer[GValueT])
// use @g_value_dup_param[Pointer[GParamSpecT]](value': NullablePointer[GValueT])
// use @g_value_dup_string[Pointer[U8]](value': NullablePointer[GValueT])
// use @g_value_dup_variant[Pointer[GVariantT]](value': NullablePointer[GValueT])
// use @g_value_fits_pointer[I32](value': NullablePointer[GValueT])
// use @g_value_get_boolean[I32](value': NullablePointer[GValueT])
// use @g_value_get_boxed[Pointer[None]](value': NullablePointer[GValueT])
...
// use @g_value_get_object[Pointer[None]](value': NullablePointer[GValueT])
// use @g_value_get_param[Pointer[GParamSpecT]](value': NullablePointer[GValueT])
// use @g_value_get_pointer[Pointer[None]](value': NullablePointer[GValueT])
// use @g_value_get_schar[I8](value': NullablePointer[GValueT])
// use @g_value_get_string[Pointer[U8]](value': NullablePointer[GValueT])
...
// use @g_value_get_variant[Pointer[GVariantT]](value': NullablePointer[GValueT])
// use @g_value_init[Pointer[GValueT]](value': NullablePointer[GValueT], g_type': U64)
// use @g_value_init_from_instance[None](value': NullablePointer[GValueT], instance': Pointer[None] tag)
// use @g_value_peek_pointer[Pointer[None]](value': NullablePointer[GValueT])
// use @g_value_reset[Pointer[GValueT]](value': NullablePointer[GValueT])
