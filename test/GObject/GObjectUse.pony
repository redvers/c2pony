...
// use @g_object_new_valist[GObjectT](object_type': U64, first_property_name': Pointer[U8] tag, var_args': valisttagT)
...
// use @g_object_bind_property[GBindingT](source': Pointer[None] tag, source_property': Pointer[U8] tag, target': Pointer[None] tag, target_property': Pointer[U8] tag, flags': U32)
// use @g_object_bind_property_full[GBindingT](source': Pointer[None] tag, source_property': Pointer[U8] tag, target': Pointer[None] tag, target_property': Pointer[U8] tag, flags': U32, transform_to': GBindingTransformFunc, transform_from': GBindingTransformFunc, user_data': Pointer[None] tag, notify': GDestroyNotify)
// use @g_object_bind_property_with_closures[GBindingT](source': Pointer[None] tag, source_property': Pointer[U8] tag, target': Pointer[None] tag, target_property': Pointer[U8] tag, flags': U32, transform_to': GClosureT, transform_from': GClosureT)
...
// use @g_object_get_valist[None](object': GObjectT, first_property_name': Pointer[U8] tag, var_args': valisttagT)
...
// use @g_object_set_valist[None](object': GObjectT, first_property_name': Pointer[U8] tag, var_args': valisttagT)
