...
// use @g_signal_connect_data[U64](instance': Pointer[None] tag, detailed_signal': Pointer[U8] tag, c_handler': GCallback, data': Pointer[None] tag, destroy_data': GClosureNotify, connect_flags': U32)
