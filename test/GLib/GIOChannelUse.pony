...
// Constructors
// use @g_io_channel_new_file[Pointer[GIOChannelT]](filename': Pointer[U8] tag, mode': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_io_channel_unix_new[Pointer[GIOChannelT]](fd': I32)
...
// use @g_io_channel_get_encoding[Pointer[U8]](channel': NullablePointer[GIOChannelT])
// use @g_io_channel_get_flags[U32](channel': NullablePointer[GIOChannelT])
// use @g_io_channel_get_line_term[Pointer[U8]](channel': NullablePointer[GIOChannelT], length': Pointer[I32] tag)
...
// use @g_io_channel_ref[Pointer[GIOChannelT]](channel': NullablePointer[GIOChannelT])
