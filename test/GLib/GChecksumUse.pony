...
// Constructors
// use @g_checksum_new[Pointer[GChecksumT]](checksum_type': U32)

// Methods
// use @g_checksum_copy[Pointer[GChecksumT]](checksum': NullablePointer[GChecksumT])
...
// use @g_checksum_get_string[Pointer[U8]](checksum': NullablePointer[GChecksumT])
