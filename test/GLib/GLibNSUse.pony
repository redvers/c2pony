...
// use @g_ascii_dtostr[Pointer[U8]](buffer': Pointer[U8] tag, buf_len': I32, d': F64)
// use @g_ascii_formatd[Pointer[U8]](buffer': Pointer[U8] tag, buf_len': I32, format': Pointer[U8] tag, d': F64)
// use @g_ascii_strcasecmp[I32](s1': Pointer[U8] tag, s2': Pointer[U8] tag)
// use @g_ascii_strdown[Pointer[U8]](str': Pointer[U8] tag, len': I64)
// use @g_ascii_string_to_signed[I32](str': Pointer[U8] tag, base': U32, min': I64, max': I64, out_num': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_ascii_string_to_unsigned[I32](str': Pointer[U8] tag, base': U32, min': U64, max': U64, out_num': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_assertion_message_error[None](domain': Pointer[U8] tag, file': Pointer[U8] tag, line': I32, func': Pointer[U8] tag, expr': Pointer[U8] tag, error': NullablePointer[GErrorT], error_domain': U32, error_code': I32)
...
// use @g_atomic_rc_box_acquire[Pointer[None]](mem_block': Pointer[None] tag)
// use @g_atomic_rc_box_alloc[Pointer[None]](block_size': U64)
// use @g_atomic_rc_box_alloc0[Pointer[None]](block_size': U64)
// use @g_atomic_rc_box_dup[Pointer[None]](block_size': U64, mem_block': Pointer[None] tag)
...
// use @g_base64_decode[Pointer[U8]](text': Pointer[U8] tag, out_len': Pointer[U64] tag)
// use @g_base64_decode_inplace[Pointer[U8]](text': Pointer[U8] tag, out_len': Pointer[U64] tag)
...
// use @g_basename[Pointer[U8]](file_name': Pointer[U8] tag)
...
// use @g_build_filename[Pointer[U8]](first_element': Pointer[U8] tag, ...)
// use @g_build_filenamev[Pointer[U8]](args': Pointer[Pointer[U8]] tag)
// use @g_build_path[Pointer[U8]](separator': Pointer[U8] tag, first_element': Pointer[U8] tag, ...)
// use @g_build_pathv[Pointer[U8]](separator': Pointer[U8] tag, args': Pointer[Pointer[U8]] tag)
// use @g_canonicalize_filename[Pointer[U8]](filename': Pointer[U8] tag, relative_to': Pointer[U8] tag)
// use @glib_check_version[Pointer[U8]](required_major': U32, required_minor': U32, required_micro': U32)
// use @g_child_watch_source_new[Pointer[GSourceT]](pid': I32)
// use @g_clear_error[None](err': Pointer[NullablePointer[GErrorT]])
// use @g_compute_checksum_for_bytes[Pointer[U8]](checksum_type': U32, data': NullablePointer[GBytesT])
// use @g_compute_checksum_for_data[Pointer[U8]](checksum_type': U32, data': Pointer[U8] tag, length': U64)
// use @g_compute_checksum_for_string[Pointer[U8]](checksum_type': U32, str': Pointer[U8] tag, length': I64)
// use @g_compute_hmac_for_bytes[Pointer[U8]](digest_type': U32, key': NullablePointer[GBytesT], data': NullablePointer[GBytesT])
// use @g_compute_hmac_for_data[Pointer[U8]](digest_type': U32, key': Pointer[U8] tag, key_len': U64, data': Pointer[U8] tag, length': U64)
// use @g_compute_hmac_for_string[Pointer[U8]](digest_type': U32, key': Pointer[U8] tag, key_len': U64, str': Pointer[U8] tag, length': I64)
// use @g_convert[Pointer[U8]](str': Pointer[U8] tag, len': I64, to_codeset': Pointer[U8] tag, from_codeset': Pointer[U8] tag, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_convert_error_quark[U32]()
// use @g_convert_with_fallback[Pointer[U8]](str': Pointer[U8] tag, len': I64, to_codeset': Pointer[U8] tag, from_codeset': Pointer[U8] tag, fallback': Pointer[U8] tag, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_convert_with_iconv[Pointer[U8]](str': Pointer[U8] tag, len': I64, converter': NullablePointer[GIConvT], bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_datalist_clear[None](datalist': Pointer[NullablePointer[GDataT]])
// use @g_datalist_get_data[Pointer[None]](datalist': Pointer[NullablePointer[GDataT]], key': Pointer[U8] tag)
// use @g_datalist_get_flags[U32](datalist': Pointer[NullablePointer[GDataT]])
// use @g_datalist_id_get_data[Pointer[None]](datalist': Pointer[NullablePointer[GDataT]], key_id': U32)
// use @g_datalist_id_remove_no_notify[Pointer[None]](datalist': Pointer[NullablePointer[GDataT]], key_id': U32)
// use @g_datalist_init[None](datalist': Pointer[NullablePointer[GDataT]])
// use @g_datalist_set_flags[None](datalist': Pointer[NullablePointer[GDataT]], flags': U32)
// use @g_datalist_unset_flags[None](datalist': Pointer[NullablePointer[GDataT]], flags': U32)
// use @g_dataset_destroy[None](dataset_location': Pointer[None] tag)
// use @g_dataset_id_get_data[Pointer[None]](dataset_location': Pointer[None] tag, key_id': U32)
// use @g_dataset_id_remove_no_notify[Pointer[None]](dataset_location': Pointer[None] tag, key_id': U32)
...
// use @g_dngettext[Pointer[U8]](domain': Pointer[U8] tag, msgid': Pointer[U8] tag, msgid_plural': Pointer[U8] tag, n': U64)
...
// use @g_file_get_contents[I32](filename': Pointer[U8] tag, contents': Pointer[Pointer[U8]] tag, length': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_file_open_tmp[I32](tmpl': Pointer[U8] tag, name_used': Pointer[Pointer[U8]] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_file_read_link[Pointer[U8]](filename': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_file_set_contents[I32](filename': Pointer[U8] tag, contents': Pointer[U8] tag, length': I64, error': Pointer[NullablePointer[GErrorT]])
// use @g_file_set_contents_full[I32](filename': Pointer[U8] tag, contents': Pointer[U8] tag, length': I64, flags': U32, mode': I32, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_filename_from_uri[Pointer[U8]](uri': Pointer[U8] tag, hostname': Pointer[Pointer[U8]] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_filename_from_utf8[Pointer[U8]](utf8string': Pointer[U8] tag, len': I64, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_filename_to_uri[Pointer[U8]](filename': Pointer[U8] tag, hostname': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_filename_to_utf8[Pointer[U8]](opsysstring': Pointer[U8] tag, len': I64, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_format_size_full[Pointer[U8]](size': U64, flags': U32)
...
// use @g_get_current_time[None](result': NullablePointer[GTimeValT])
...
// use @g_get_language_names_with_category[Pointer[Pointer[U8]]](category_name': Pointer[U8] tag)
...
// use @g_get_os_info[Pointer[U8]](key_name': Pointer[U8] tag)
...
// use @g_get_user_special_dir[Pointer[U8]](directory': U32)
...
// use @g_idle_source_new[Pointer[GSourceT]]()
...
// use @g_io_create_watch[Pointer[GSourceT]](channel': NullablePointer[GIOChannelT], condition': U32)
// use @g_listenv[Pointer[Pointer[U8]]]()
// use @g_locale_from_utf8[Pointer[U8]](utf8string': Pointer[U8] tag, len': I64, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_locale_to_utf8[Pointer[U8]](opsysstring': Pointer[U8] tag, len': I64, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_log_structured_array[None](log_level': I32, fields': NullablePointer[GLogFieldT], n_fields': U64)
...
// use @g_log_writer_default[U32](log_level': I32, fields': NullablePointer[GLogFieldT], n_fields': U64, user_data': Pointer[None] tag)
// use @g_log_writer_format_fields[Pointer[U8]](log_level': I32, fields': NullablePointer[GLogFieldT], n_fields': U64, use_color': I32)
// use @g_log_writer_is_journald[I32](output_fd': I32)
// use @g_log_writer_journald[U32](log_level': I32, fields': NullablePointer[GLogFieldT], n_fields': U64, user_data': Pointer[None] tag)
// use @g_log_writer_standard_streams[U32](log_level': I32, fields': NullablePointer[GLogFieldT], n_fields': U64, user_data': Pointer[None] tag)
// use @g_log_writer_supports_color[I32](output_fd': I32)
// use @g_logv[None](log_domain': Pointer[U8] tag, log_level': I32, format': Pointer[U8] tag, args': NullablePointer[valisttagT])
// use @g_main_current_source[Pointer[GSourceT]]()
// use @g_main_depth[I32]()
// use @g_malloc[Pointer[None]](n_bytes': U64)
// use @g_malloc0[Pointer[None]](n_bytes': U64)
// use @g_malloc0_n[Pointer[None]](n_blocks': U64, n_block_bytes': U64)
// use @g_malloc_n[Pointer[None]](n_blocks': U64, n_block_bytes': U64)
// use @g_markup_collect_attributes[I32](element_name': Pointer[U8] tag, attribute_names': Pointer[Pointer[U8]] tag, attribute_values': Pointer[Pointer[U8]] tag, error': Pointer[NullablePointer[GErrorT]], first_type': U32, first_attr': Pointer[U8] tag, ...)
...
// use @g_markup_vprintf_escaped[Pointer[U8]](format': Pointer[U8] tag, args': NullablePointer[valisttagT])
// use @g_mem_profile[None]()
// use @g_mem_set_vtable[None](vtable': NullablePointer[GMemVTableT])
// use @g_memdup[Pointer[None]](mem': Pointer[None] tag, byte_size': U32)
...
// use @g_parse_debug_string[U32](string': Pointer[U8] tag, keys': NullablePointer[GDebugKeyT], nkeys': U32)
// use @g_path_get_basename[Pointer[U8]](file_name': Pointer[U8] tag)
// use @g_path_get_dirname[Pointer[U8]](file_name': Pointer[U8] tag)
// use @g_path_is_absolute[I32](file_name': Pointer[U8] tag)
// use @g_path_skip_root[Pointer[U8]](file_name': Pointer[U8] tag)
// use @g_pattern_match[I32](pspec': NullablePointer[GPatternSpecT], string_length': U32, string': Pointer[U8] tag, string_reversed': Pointer[U8] tag)
// use @g_pattern_match_simple[I32](pattern': Pointer[U8] tag, string': Pointer[U8] tag)
// use @g_pattern_match_string[I32](pspec': NullablePointer[GPatternSpecT], string': Pointer[U8] tag)
...
// use @g_poll[I32](fds': NullablePointer[GPollFDT], nfds': U32, timeout': I32)
// use @g_prefix_error[None](err': Pointer[NullablePointer[GErrorT]], format': Pointer[U8] tag, ...)
// use @g_print[None](format': Pointer[U8] tag, ...)
// use @g_printerr[None](format': Pointer[U8] tag, ...)
// use @g_printf_string_upper_bound[U64](format': Pointer[U8] tag, args': NullablePointer[valisttagT])
// use @g_propagate_error[None](dest': Pointer[NullablePointer[GErrorT]], src': NullablePointer[GErrorT])
// use @g_propagate_prefixed_error[None](dest': Pointer[NullablePointer[GErrorT]], src': NullablePointer[GErrorT], format': Pointer[U8] tag, ...)
...
// use @g_rc_box_acquire[Pointer[None]](mem_block': Pointer[None] tag)
// use @g_rc_box_alloc[Pointer[None]](block_size': U64)
// use @g_rc_box_alloc0[Pointer[None]](block_size': U64)
// use @g_rc_box_dup[Pointer[None]](block_size': U64, mem_block': Pointer[None] tag)
// use @g_rc_box_get_size[U64](mem_block': Pointer[None] tag)
// use @g_rc_box_release[None](mem_block': Pointer[None] tag)
// use @g_realloc[Pointer[None]](mem': Pointer[None] tag, n_bytes': U64)
// use @g_realloc_n[Pointer[None]](mem': Pointer[None] tag, n_blocks': U64, n_block_bytes': U64)
...
// use @g_set_error[None](err': Pointer[NullablePointer[GErrorT]], domain': U32, code': I32, format': Pointer[U8] tag, ...)
// use @g_set_error_literal[None](err': Pointer[NullablePointer[GErrorT]], domain': U32, code': I32, message': Pointer[U8] tag)
...
// use @g_shell_quote[Pointer[U8]](unquoted_string': Pointer[U8] tag)
// use @g_shell_unquote[Pointer[U8]](quoted_string': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_slice_alloc[Pointer[None]](block_size': U64)
// use @g_slice_alloc0[Pointer[None]](block_size': U64)
// use @g_slice_copy[Pointer[None]](block_size': U64, mem_block': Pointer[None] tag)
...
// use @g_slice_get_config_state[Pointer[I64]](ckey': U32, address': I64, n_values': Pointer[U32] tag)
...
// use @g_spawn_check_exit_status[I32](wait_status': I32, error': Pointer[NullablePointer[GErrorT]])
// use @g_spawn_close_pid[None](pid': I32)
// use @g_spawn_command_line_async[I32](command_line': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_spawn_command_line_sync[I32](command_line': Pointer[U8] tag, standard_output': Pointer[Pointer[U8]] tag, standard_error': Pointer[Pointer[U8]] tag, wait_status': Pointer[I32] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_str_to_ascii[Pointer[U8]](str': Pointer[U8] tag, from_locale': Pointer[U8] tag)
// use @g_strcanon[Pointer[U8]](string': Pointer[U8] tag, valid_chars': Pointer[U8] tag, substitutor': U8)
...
// use @g_strdelimit[Pointer[U8]](string': Pointer[U8] tag, delimiters': Pointer[U8] tag, new_delimiter': U8)
...
// use @g_strdup_vprintf[Pointer[U8]](format': Pointer[U8] tag, args': NullablePointer[valisttagT])
// use @g_strdupv[Pointer[Pointer[U8]]](str_array': Pointer[Pointer[U8]] tag)
...
// use @g_string_new[Pointer[GStringT]](init': Pointer[U8] tag)
// use @g_string_new_len[Pointer[GStringT]](init': Pointer[U8] tag, len': I64)
// use @g_string_sized_new[Pointer[GStringT]](dfl_size': U64)
...
// use @g_strjoinv[Pointer[U8]](separator': Pointer[U8] tag, str_array': Pointer[Pointer[U8]] tag)
...
// use @g_strnfill[Pointer[U8]](length': U64, fill_char': U8)
// use @g_strreverse[Pointer[U8]](string': Pointer[U8] tag)
// use @g_strrstr[Pointer[U8]](haystack': Pointer[U8] tag, needle': Pointer[U8] tag)
// use @g_strrstr_len[Pointer[U8]](haystack': Pointer[U8] tag, haystack_len': I64, needle': Pointer[U8] tag)
// use @g_strsignal[Pointer[U8]](signum': I32)
// use @g_strsplit[Pointer[Pointer[U8]]](string': Pointer[U8] tag, delimiter': Pointer[U8] tag, max_tokens': I32)
// use @g_strsplit_set[Pointer[Pointer[U8]]](string': Pointer[U8] tag, delimiters': Pointer[U8] tag, max_tokens': I32)
// use @g_strstr_len[Pointer[U8]](haystack': Pointer[U8] tag, haystack_len': I64, needle': Pointer[U8] tag)
...
// use @g_test_build_filename[Pointer[U8]](file_type': U32, first_path': Pointer[U8] tag, ...)
// use @g_test_create_suite[Pointer[GTestSuiteT]](suite_name': Pointer[U8] tag)
...
// use @g_test_get_dir[Pointer[U8]](file_type': U32)
// use @g_test_get_filename[Pointer[U8]](file_type': U32, first_path': Pointer[U8] tag, ...)
// use @g_test_get_root[Pointer[GTestSuiteT]]()
// use @g_test_incomplete[None](msg': Pointer[U8] tag)
// use @g_test_log_type_name[Pointer[U8]](log_type': U32)
...
// use @g_test_run[I32]()
// use @g_test_run_suite[I32](suite': NullablePointer[GTestSuiteT])
...
// use @g_timeout_source_new[Pointer[GSourceT]](interval': U32)
// use @g_timeout_source_new_seconds[Pointer[GSourceT]](interval': U32)
// use @g_try_malloc[Pointer[None]](n_bytes': U64)
// use @g_try_malloc0[Pointer[None]](n_bytes': U64)
// use @g_try_malloc0_n[Pointer[None]](n_blocks': U64, n_block_bytes': U64)
// use @g_try_malloc_n[Pointer[None]](n_blocks': U64, n_block_bytes': U64)
// use @g_try_realloc[Pointer[None]](mem': Pointer[None] tag, n_bytes': U64)
// use @g_try_realloc_n[Pointer[None]](mem': Pointer[None] tag, n_blocks': U64, n_block_bytes': U64)
// use @g_ucs4_to_utf16[Pointer[U16]](str': Pointer[U32] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_ucs4_to_utf8[Pointer[U8]](str': Pointer[U32] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_utf16_to_ucs4[Pointer[U32]](str': Pointer[U16] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_utf16_to_utf8[Pointer[U8]](str': Pointer[U16] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_utf8_find_next_char[Pointer[U8]](p': Pointer[U8] tag, end': Pointer[U8] tag)
...
// use @g_utf8_normalize[Pointer[U8]](str': Pointer[U8] tag, len': I64, mode': U32)
...
// use @g_utf8_substring[Pointer[U8]](str': Pointer[U8] tag, start_pos': I64, end_pos': I64)
// use @g_utf8_to_ucs4[Pointer[U32]](str': Pointer[U8] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_utf8_to_ucs4_fast[Pointer[U32]](str': Pointer[U8] tag, len': I64, items_written': Pointer[I64] tag)
// use @g_utf8_to_utf16[Pointer[U16]](str': Pointer[U8] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_vsnprintf[I32](string': Pointer[U8] tag, n': U64, format': Pointer[U8] tag, args': NullablePointer[valisttagT])
