...
// use @g_child_watch_source_new[NullablePointer[GSourceT]](pid': I32)
...
// use @g_clear_list[None](list_ptr': Pointer[NullablePointer[GListT]], destroy': GDestroyNotify)
// use @g_clear_pointer[None](pp': Pointer[Pointer[None]] tag, destroy': GDestroyNotify)
// use @g_clear_slist[None](slist_ptr': Pointer[NullablePointer[GSListT]], destroy': GDestroyNotify)
// use @g_compute_checksum_for_bytes[Pointer[U8] tag](checksum_type': U32, data': NullablePointer[GBytesT])
...
// use @g_compute_hmac_for_bytes[Pointer[U8] tag](digest_type': U32, key': NullablePointer[GBytesT], data': NullablePointer[GBytesT])
...
// use @g_convert[Pointer[U8] tag](str': Pointer[U8] tag, len': I64, to_codeset': Pointer[U8] tag, from_codeset': Pointer[U8] tag, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_convert_error_quark[U32]()
// use @g_convert_with_fallback[Pointer[U8] tag](str': Pointer[U8] tag, len': I64, to_codeset': Pointer[U8] tag, from_codeset': Pointer[U8] tag, fallback': Pointer[U8] tag, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_convert_with_iconv[Pointer[U8] tag](str': Pointer[U8] tag, len': I64, converter': NullablePointer[GIConvT], bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_datalist_clear[None](datalist': Pointer[NullablePointer[GDataT]])
// use @g_datalist_foreach[None](datalist': Pointer[NullablePointer[GDataT]], func': GDataForeachFunc, user_data': Pointer[None] tag)
// use @g_datalist_get_data[Pointer[None] tag](datalist': Pointer[NullablePointer[GDataT]], key': Pointer[U8] tag)
// use @g_datalist_get_flags[U32](datalist': Pointer[NullablePointer[GDataT]])
// use @g_datalist_id_dup_data[Pointer[None] tag](datalist': Pointer[NullablePointer[GDataT]], key_id': U32, dup_func': GDuplicateFunc, user_data': Pointer[None] tag)
// use @g_datalist_id_get_data[Pointer[None] tag](datalist': Pointer[NullablePointer[GDataT]], key_id': U32)
// use @g_datalist_id_remove_no_notify[Pointer[None] tag](datalist': Pointer[NullablePointer[GDataT]], key_id': U32)
// use @g_datalist_id_set_data_full[None](datalist': Pointer[NullablePointer[GDataT]], key_id': U32, data': Pointer[None] tag, destroy_func': GDestroyNotify)
...
// use @g_file_read_link[Pointer[U8] tag](filename': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_filename_from_uri[Pointer[U8] tag](uri': Pointer[U8] tag, hostname': Pointer[Pointer[U8]] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_filename_from_utf8[Pointer[U8] tag](utf8string': Pointer[U8] tag, len': I64, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_filename_to_uri[Pointer[U8] tag](filename': Pointer[U8] tag, hostname': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_filename_to_utf8[Pointer[U8] tag](opsysstring': Pointer[U8] tag, len': I64, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_idle_source_new[NullablePointer[GSourceT]]()
...
// use @g_io_add_watch[U32](channel': NullablePointer[GIOChannelT], condition': U32, func': GIOFunc, user_data': Pointer[None] tag)
// use @g_io_add_watch_full[U32](channel': NullablePointer[GIOChannelT], priority': I32, condition': U32, func': GIOFunc, user_data': Pointer[None] tag, notify': GDestroyNotify)
// use @g_io_create_watch[NullablePointer[GSourceT]](channel': NullablePointer[GIOChannelT], condition': U32)
// use @g_listenv[Pointer[Pointer[U8]] tag]()
// use @g_locale_from_utf8[Pointer[U8] tag](utf8string': Pointer[U8] tag, len': I64, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_locale_to_utf8[Pointer[U8] tag](opsysstring': Pointer[U8] tag, len': I64, bytes_read': Pointer[U64] tag, bytes_written': Pointer[U64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_log_writer_format_fields[Pointer[U8] tag](log_level': I32, fields': NullablePointer[GLogFieldT], n_fields': U64, use_color': I32)
...
// use @g_main_current_source[NullablePointer[GSourceT]]()
...
// use @g_markup_vprintf_escaped[Pointer[U8] tag](format': Pointer[U8] tag, args': NullablePointer[valisttagT])
...
// use @g_shell_parse_argv[I32](command_line': Pointer[U8] tag, argcp': Pointer[I32] tag, argvp': Pointer[Pointer[Pointer[U8]]] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_shell_quote[Pointer[U8] tag](unquoted_string': Pointer[U8] tag)
// use @g_shell_unquote[Pointer[U8] tag](quoted_string': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_spawn_async[I32](working_directory': Pointer[U8] tag, argv': Pointer[Pointer[U8]] tag, envp': Pointer[Pointer[U8]] tag, flags': U32, child_setup': GSpawnChildSetupFunc, user_data': Pointer[None] tag, child_pid': Pointer[I32] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_spawn_async_with_fds[I32](working_directory': Pointer[U8] tag, argv': Pointer[Pointer[U8]] tag, envp': Pointer[Pointer[U8]] tag, flags': U32, child_setup': GSpawnChildSetupFunc, user_data': Pointer[None] tag, child_pid': Pointer[I32] tag, stdin_fd': I32, stdout_fd': I32, stderr_fd': I32, error': Pointer[NullablePointer[GErrorT]])
// use @g_spawn_async_with_pipes[I32](working_directory': Pointer[U8] tag, argv': Pointer[Pointer[U8]] tag, envp': Pointer[Pointer[U8]] tag, flags': U32, child_setup': GSpawnChildSetupFunc, user_data': Pointer[None] tag, child_pid': Pointer[I32] tag, standard_input': Pointer[I32] tag, standard_output': Pointer[I32] tag, standard_error': Pointer[I32] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_strdup_vprintf[Pointer[U8] tag](format': Pointer[U8] tag, args': NullablePointer[valisttagT])
...
// use @g_string_new[NullablePointer[GStringT]](init': Pointer[U8] tag)
// use @g_string_new_len[NullablePointer[GStringT]](init': Pointer[U8] tag, len': I64)
// use @g_string_sized_new[NullablePointer[GStringT]](dfl_size': U64)
...
// use @g_test_create_case[NullablePointer[GTestCaseT]](test_name': Pointer[U8] tag, data_size': U64, test_data': Pointer[None] tag, data_setup': GTestFixtureFunc, data_test': GTestFixtureFunc, data_teardown': GTestFixtureFunc)
// use @g_test_create_suite[NullablePointer[GTestSuiteT]](suite_name': Pointer[U8] tag)
...
// use @g_test_get_root[NullablePointer[GTestSuiteT]]()
...
// use @g_timeout_source_new[NullablePointer[GSourceT]](interval': U32)
// use @g_timeout_source_new_seconds[NullablePointer[GSourceT]](interval': U32)
...
// use @g_ucs4_to_utf16[Pointer[U16] tag](str': Pointer[U32] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_ucs4_to_utf8[Pointer[U8] tag](str': Pointer[U32] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_utf16_to_ucs4[Pointer[U32] tag](str': Pointer[U16] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_utf16_to_utf8[Pointer[U8] tag](str': Pointer[U16] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_utf8_to_ucs4[Pointer[U32] tag](str': Pointer[U8] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
// use @g_utf8_to_ucs4_fast[Pointer[U32] tag](str': Pointer[U8] tag, len': I64, items_written': Pointer[I64] tag)
// use @g_utf8_to_utf16[Pointer[U16] tag](str': Pointer[U8] tag, len': I64, items_read': Pointer[I64] tag, items_written': Pointer[I64] tag, error': Pointer[NullablePointer[GErrorT]])
