...
*/
/* 
fun free(array': NullablePointer[GPtrArrayT], free_seg': I32): Pointer[Pointer[None]] =>
...
*/
/* 
fun create(): Pointer[GPtrArrayT] =>
    @g_ptr_array_new()
*/
/* 
fun ref(array': NullablePointer[GPtrArrayT]): Pointer[GPtrArrayT] =>
...
*/
/* 
fun remove_index(array': NullablePointer[GPtrArrayT], index_': U32): Pointer[None] =>
    @g_ptr_array_remove_index(array', index_')
*/
/* 
fun remove_index_fast(array': NullablePointer[GPtrArrayT], index_': U32): Pointer[None] =>
    @g_ptr_array_remove_index_fast(array', index_')
*/
/* 
fun remove_range(array': NullablePointer[GPtrArrayT], index_': U32, length': U32): Pointer[GPtrArrayT] =>
...
*/
/* 
fun sized_new(reserved_size': U32): Pointer[GPtrArrayT] =>
    @g_ptr_array_sized_new(reserved_size')
*/
/* 
fun steal(array': NullablePointer[GPtrArrayT], len': Pointer[U64] tag): Pointer[Pointer[None]] =>
    @g_ptr_array_steal(array', len')
*/
/* 
fun steal_index(array': NullablePointer[GPtrArrayT], index_': U32): Pointer[None] =>
    @g_ptr_array_steal_index(array', index_')
*/
/* 
fun steal_index_fast(array': NullablePointer[GPtrArrayT], index_': U32): Pointer[None] =>
