...
// Static Functions
// use @g_scanner_new[Pointer[GScannerT]](config_templ': NullablePointer[GScannerConfigT])
...
// use @g_scanner_cur_value[FIXME Union](scanner': NullablePointer[GScannerT])
...
// use @g_scanner_lookup_symbol[Pointer[None]](scanner': NullablePointer[GScannerT], symbol': Pointer[U8] tag)
...
// use @g_scanner_scope_lookup_symbol[Pointer[None]](scanner': NullablePointer[GScannerT], scope_id': U32, symbol': Pointer[U8] tag)
