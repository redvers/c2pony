...
// Static Functions
// use @g_slist_alloc[NullablePointer[GSListT]]()
...
// use @g_slist_nth_data[Pointer[None] tag](list': NullablePointer[GSListT], n': U32)
// use @g_slist_position[I32](list': NullablePointer[GSListT], llink': NullablePointer[GSListT])
// use @g_slist_prepend[NullablePointer[GSListT]](list': NullablePointer[GSListT], data': Pointer[None] tag)
// use @g_slist_remove[NullablePointer[GSListT]](list': NullablePointer[GSListT], data': Pointer[None] tag)
