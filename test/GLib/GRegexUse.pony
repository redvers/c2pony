...
// use @g_regex_split_simple[Pointer[Pointer[U8]]](pattern': Pointer[U8] tag, string': Pointer[U8] tag, compile_options': U32, match_options': U32)

// Constructors
// use @g_regex_new[Pointer[GRegexT]](pattern': Pointer[U8] tag, compile_options': U32, match_options': U32, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_regex_get_pattern[Pointer[U8]](regex': NullablePointer[GRegexT])
...
// use @g_regex_ref[Pointer[GRegexT]](regex': NullablePointer[GRegexT])
// use @g_regex_replace[Pointer[U8]](regex': NullablePointer[GRegexT], string': Pointer[U8] tag, string_len': I64, start_position': I32, replacement': Pointer[U8] tag, match_options': U32, error': Pointer[NullablePointer[GErrorT]])
// use @g_regex_replace_literal[Pointer[U8]](regex': NullablePointer[GRegexT], string': Pointer[U8] tag, string_len': I64, start_position': I32, replacement': Pointer[U8] tag, match_options': U32, error': Pointer[NullablePointer[GErrorT]])
// use @g_regex_split[Pointer[Pointer[U8]]](regex': NullablePointer[GRegexT], string': Pointer[U8] tag, match_options': U32)
// use @g_regex_split_full[Pointer[Pointer[U8]]](regex': NullablePointer[GRegexT], string': Pointer[U8] tag, string_len': I64, start_position': I32, match_options': U32, max_tokens': I32, error': Pointer[NullablePointer[GErrorT]])
