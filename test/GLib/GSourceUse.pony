...
// Constructors
// use @g_source_new[Pointer[GSourceT]](source_funcs': NullablePointer[GSourceFuncsT], struct_size': U32)
...
// use @g_source_add_unix_fd[Pointer[None]](source': NullablePointer[GSourceT], fd': I32, events': U32)
...
// use @g_source_get_context[Pointer[GMainContextT]](source': NullablePointer[GSourceT])
...
// use @g_source_get_name[Pointer[U8]](source': NullablePointer[GSourceT])
...
// use @g_source_ref[Pointer[GSourceT]](source': NullablePointer[GSourceT])
