...
// use @g_source_set_callback[None](source': NullablePointer[GSourceT], func': GSourceFunc, data': Pointer[None] tag, notify': GDestroyNotify)
...
// use @g_source_set_dispose_function[None](source': NullablePointer[GSourceT], dispose': GSourceDisposeFunc)
