...
// Static Functions
// use @g_uri_build[NullablePointer[GUriT]](flags': U32, scheme': Pointer[U8] tag, userinfo': Pointer[U8] tag, host': Pointer[U8] tag, port': I32, path': Pointer[U8] tag, query': Pointer[U8] tag, fragment': Pointer[U8] tag)
// use @g_uri_build_with_user[NullablePointer[GUriT]](flags': U32, scheme': Pointer[U8] tag, user': Pointer[U8] tag, password': Pointer[U8] tag, auth_params': Pointer[U8] tag, host': Pointer[U8] tag, port': I32, path': Pointer[U8] tag, query': Pointer[U8] tag, fragment': Pointer[U8] tag)
...
// use @g_uri_parse[NullablePointer[GUriT]](uri_string': Pointer[U8] tag, flags': U32, error': Pointer[NullablePointer[GErrorT]])
// use @g_uri_parse_params[NullablePointer[GHashTableT]](params': Pointer[U8] tag, length': I64, separators': Pointer[U8] tag, flags': U32, error': Pointer[NullablePointer[GErrorT]])
// use @g_uri_parse_scheme[Pointer[U8] tag](uri': Pointer[U8] tag)
// use @g_uri_peek_scheme[Pointer[U8] tag](uri': Pointer[U8] tag)
// use @g_uri_resolve_relative[Pointer[U8] tag](base_uri_string': Pointer[U8] tag, uri_ref': Pointer[U8] tag, flags': U32, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_uri_unescape_bytes[NullablePointer[GBytesT]](escaped_string': Pointer[U8] tag, length': I64, illegal_characters': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
...
// Methods
// use @g_uri_get_auth_params[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_get_flags[U32](uri': NullablePointer[GUriT])
// use @g_uri_get_fragment[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_get_host[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_get_password[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_get_path[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_get_port[I32](uri': NullablePointer[GUriT])
// use @g_uri_get_query[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_get_scheme[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_get_user[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_get_userinfo[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_parse_relative[NullablePointer[GUriT]](base_uri': NullablePointer[GUriT], uri_ref': Pointer[U8] tag, flags': U32, error': Pointer[NullablePointer[GErrorT]])
// use @g_uri_ref[NullablePointer[GUriT]](uri': NullablePointer[GUriT])
// use @g_uri_to_string[Pointer[U8] tag](uri': NullablePointer[GUriT])
// use @g_uri_to_string_partial[Pointer[U8] tag](uri': NullablePointer[GUriT], flags': U32)
