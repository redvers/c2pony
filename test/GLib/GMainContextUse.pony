...
// Static Functions
// use @g_main_context_default[Pointer[GMainContextT]]()
// use @g_main_context_get_thread_default[Pointer[GMainContextT]]()
// use @g_main_context_ref_thread_default[Pointer[GMainContextT]]()

// Constructors
// use @g_main_context_new[Pointer[GMainContextT]]()
...
// use @g_main_context_find_source_by_funcs_user_data[Pointer[GSourceT]](context': NullablePointer[GMainContextT], funcs': NullablePointer[GSourceFuncsT], user_data': Pointer[None] tag)
// use @g_main_context_find_source_by_id[Pointer[GSourceT]](context': NullablePointer[GMainContextT], source_id': U32)
// use @g_main_context_find_source_by_user_data[Pointer[GSourceT]](context': NullablePointer[GMainContextT], user_data': Pointer[None] tag)
// use @g_main_context_get_poll_func[Pointer[FIXME FunctionType]](context': NullablePointer[GMainContextT])
...
// use @g_main_context_ref[Pointer[GMainContextT]](context': NullablePointer[GMainContextT])
