...
// use @g_main_context_get_poll_func[GPollFunc](context': NullablePointer[GMainContextT])
// use @g_main_context_invoke[None](context': NullablePointer[GMainContextT], function': GSourceFunc, data': Pointer[None] tag)
// use @g_main_context_invoke_full[None](context': NullablePointer[GMainContextT], priority': I32, function': GSourceFunc, data': Pointer[None] tag, notify': GDestroyNotify)
...
// use @g_main_context_set_poll_func[None](context': NullablePointer[GMainContextT], func': GPollFunc)
