...
// use @g_async_queue_pop[Pointer[None] tag](queue': NullablePointer[GAsyncQueueT])
// use @g_async_queue_pop_unlocked[Pointer[None] tag](queue': NullablePointer[GAsyncQueueT])
...
// use @g_async_queue_timeout_pop_unlocked[Pointer[None] tag](queue': NullablePointer[GAsyncQueueT], timeout': U64)
// use @g_async_queue_try_pop[Pointer[None] tag](queue': NullablePointer[GAsyncQueueT])
// use @g_async_queue_try_pop_unlocked[Pointer[None] tag](queue': NullablePointer[GAsyncQueueT])
