...
// use @g_io_stream_get_input_stream[Pointer[GInputStreamT]](stream': NullablePointer[GIOStreamT])
// use @g_io_stream_get_output_stream[Pointer[GOutputStreamT]](stream': NullablePointer[GIOStreamT])
