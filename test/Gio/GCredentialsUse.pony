...
// Constructors
// use @g_credentials_new[Pointer[GCredentialsT]]()

// Methods
// use @g_credentials_get_native[Pointer[None]](credentials': NullablePointer[GCredentialsT], native_type': U32)
...
// use @g_credentials_to_string[Pointer[U8]](credentials': NullablePointer[GCredentialsT])
