...
// Constructors
// use @g_menu_item_new[NullablePointer[GMenuItemT]](label': Pointer[U8] tag, detailed_action': Pointer[U8] tag)
// use @g_menu_item_new_from_model[NullablePointer[GMenuItemT]](model': NullablePointer[GMenuModelT], item_index': I32)
// use @g_menu_item_new_section[NullablePointer[GMenuItemT]](label': Pointer[U8] tag, section': NullablePointer[GMenuModelT])
// use @g_menu_item_new_submenu[NullablePointer[GMenuItemT]](label': Pointer[U8] tag, submenu': NullablePointer[GMenuModelT])
...
// use @g_menu_item_get_attribute_value[NullablePointer[GVariantT]](menu_item': NullablePointer[GMenuItemT], attribute': Pointer[U8] tag, expected_type': NullablePointer[GVariantTypeT])
// use @g_menu_item_get_link[NullablePointer[GMenuModelT]](menu_item': NullablePointer[GMenuItemT], link': Pointer[U8] tag)
