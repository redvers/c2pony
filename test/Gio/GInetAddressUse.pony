...
// Constructors
// use @g_inet_address_new_any[Pointer[GInetAddressT]](family': U32)
// use @g_inet_address_new_from_bytes[Pointer[GInetAddressT]](bytes': Pointer[U8] tag, family': U32)
// use @g_inet_address_new_from_string[Pointer[GInetAddressT]](string': Pointer[U8] tag)
// use @g_inet_address_new_loopback[Pointer[GInetAddressT]](family': U32)
...
// use @g_inet_address_to_bytes[Pointer[U8]](address': NullablePointer[GInetAddressT])
// use @g_inet_address_to_string[Pointer[U8]](address': NullablePointer[GInetAddressT])
