...
// Methods
// use @g_task_get_cancellable[Pointer[GCancellableT]](task': NullablePointer[GTaskT])
// use @g_task_get_check_cancellable[I32](task': NullablePointer[GTaskT])
// use @g_task_get_completed[I32](task': NullablePointer[GTaskT])
// use @g_task_get_context[Pointer[GMainContextT]](task': NullablePointer[GTaskT])
// use @g_task_get_name[Pointer[U8]](task': NullablePointer[GTaskT])
// use @g_task_get_priority[I32](task': NullablePointer[GTaskT])
// use @g_task_get_return_on_cancel[I32](task': NullablePointer[GTaskT])
// use @g_task_get_source_object[Pointer[None]](task': NullablePointer[GTaskT])
// use @g_task_get_source_tag[Pointer[None]](task': NullablePointer[GTaskT])
// use @g_task_get_task_data[Pointer[None]](task': NullablePointer[GTaskT])
...
// use @g_task_propagate_pointer[Pointer[None]](task': NullablePointer[GTaskT], error': Pointer[NullablePointer[GErrorT]])
