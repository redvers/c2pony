...
// Constructors
// use @g_subprocess_launcher_new[NullablePointer[GSubprocessLauncherT]](flags': U32)
...
// use @g_subprocess_launcher_spawn[NullablePointer[GSubprocessT]](self': NullablePointer[GSubprocessLauncherT], error': Pointer[NullablePointer[GErrorT]], argv0': Pointer[U8] tag, ...)
// use @g_subprocess_launcher_spawnv[NullablePointer[GSubprocessT]](self': NullablePointer[GSubprocessLauncherT], argv': Pointer[Pointer[U8]] tag, error': Pointer[NullablePointer[GErrorT]])
