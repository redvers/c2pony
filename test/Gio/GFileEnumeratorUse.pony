...
// use @g_file_enumerator_get_child[Pointer[GFileT]](enumerator': NullablePointer[GFileEnumeratorT], info': NullablePointer[GFileInfoT])
// use @g_file_enumerator_get_container[Pointer[GFileT]](enumerator': NullablePointer[GFileEnumeratorT])
...
// use @g_file_enumerator_next_file[Pointer[GFileInfoT]](enumerator': NullablePointer[GFileEnumeratorT], cancellable': NullablePointer[GCancellableT], error': Pointer[NullablePointer[GErrorT]])
// use @g_file_enumerator_next_files_finish[Pointer[GListT]](enumerator': NullablePointer[GFileEnumeratorT], result': NullablePointer[GAsyncResultT], error': Pointer[NullablePointer[GErrorT]])
