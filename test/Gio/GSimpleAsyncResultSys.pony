...
// Methods
/* 
fun complete(simple': NullablePointer[GSimpleAsyncResultT]): None =>
    @g_simple_async_result_complete(simple')
*/
/* 
fun complete_in_idle(simple': NullablePointer[GSimpleAsyncResultT]): None =>
    @g_simple_async_result_complete_in_idle(simple')
*/
/* 
fun get_op_res_gboolean(simple': NullablePointer[GSimpleAsyncResultT]): I32 =>
    @g_simple_async_result_get_op_res_gboolean(simple')
*/
/* 
fun get_op_res_gpointer(simple': NullablePointer[GSimpleAsyncResultT]): Pointer[None] tag =>
    @g_simple_async_result_get_op_res_gpointer(simple')
*/
/* 
fun get_op_res_gssize(simple': NullablePointer[GSimpleAsyncResultT]): I64 =>
    @g_simple_async_result_get_op_res_gssize(simple')
*/
/* 
fun get_source_tag(simple': NullablePointer[GSimpleAsyncResultT]): Pointer[None] tag =>
    @g_simple_async_result_get_source_tag(simple')
*/
/* 
fun propagate_error(simple': NullablePointer[GSimpleAsyncResultT], dest': Pointer[NullablePointer[GErrorT]]): I32 =>
...
*/
/* 
fun set_error(simple': NullablePointer[GSimpleAsyncResultT], domain': U32, code': I32, format': Pointer[U8] tag, ...): None =>
    @g_simple_async_result_set_error(simple', domain', code', format', ...)
*/
/* 
fun set_error_va(simple': NullablePointer[GSimpleAsyncResultT], domain': U32, code': I32, format': Pointer[U8] tag, args': NullablePointer[valisttagT]): None =>
    @g_simple_async_result_set_error_va(simple', domain', code', format', args')
*/
/* 
fun set_from_error(simple': NullablePointer[GSimpleAsyncResultT], error': NullablePointer[GErrorT]): None =>
    @g_simple_async_result_set_from_error(simple', error')
*/
/* 
fun set_handle_cancellation(simple': NullablePointer[GSimpleAsyncResultT], handle_cancellation': I32): None =>
...
*/
/* 
fun take_error(simple': NullablePointer[GSimpleAsyncResultT], error': NullablePointer[GErrorT]): None =>
