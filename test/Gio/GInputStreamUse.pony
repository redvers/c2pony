...
// use @g_input_stream_read_bytes[Pointer[GBytesT]](stream': NullablePointer[GInputStreamT], count': U64, cancellable': NullablePointer[GCancellableT], error': Pointer[NullablePointer[GErrorT]])
// use @g_input_stream_read_bytes_finish[Pointer[GBytesT]](stream': NullablePointer[GInputStreamT], result': NullablePointer[GAsyncResultT], error': Pointer[NullablePointer[GErrorT]])
