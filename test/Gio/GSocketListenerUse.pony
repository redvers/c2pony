...
// Constructors
// use @g_socket_listener_new[Pointer[GSocketListenerT]]()

// Methods
// use @g_socket_listener_accept[Pointer[GSocketConnectionT]](listener': NullablePointer[GSocketListenerT], source_object': Pointer[NullablePointer[GObjectT]], cancellable': NullablePointer[GCancellableT], error': Pointer[NullablePointer[GErrorT]])
// use @g_socket_listener_accept_finish[Pointer[GSocketConnectionT]](listener': NullablePointer[GSocketListenerT], result': NullablePointer[GAsyncResultT], source_object': Pointer[NullablePointer[GObjectT]], error': Pointer[NullablePointer[GErrorT]])
// use @g_socket_listener_accept_socket[Pointer[GSocketT]](listener': NullablePointer[GSocketListenerT], source_object': Pointer[NullablePointer[GObjectT]], cancellable': NullablePointer[GCancellableT], error': Pointer[NullablePointer[GErrorT]])
// use @g_socket_listener_accept_socket_finish[Pointer[GSocketT]](listener': NullablePointer[GSocketListenerT], result': NullablePointer[GAsyncResultT], source_object': Pointer[NullablePointer[GObjectT]], error': Pointer[NullablePointer[GErrorT]])
