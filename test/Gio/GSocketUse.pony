...
// Constructors
// use @g_socket_new[Pointer[GSocketT]](family': U32, type': U32, protocol': I32, error': Pointer[NullablePointer[GErrorT]])
// use @g_socket_new_from_fd[Pointer[GSocketT]](fd': I32, error': Pointer[NullablePointer[GErrorT]])

// Methods
// use @g_socket_accept[Pointer[GSocketT]](socket': NullablePointer[GSocketT], cancellable': NullablePointer[GCancellableT], error': Pointer[NullablePointer[GErrorT]])
...
// use @g_socket_connection_factory_create_connection[Pointer[GSocketConnectionT]](socket': NullablePointer[GSocketT])
// use @g_socket_create_source[Pointer[GSourceT]](socket': NullablePointer[GSocketT], condition': U32, cancellable': NullablePointer[GCancellableT])
...
// use @g_socket_get_credentials[Pointer[GCredentialsT]](socket': NullablePointer[GSocketT], error': Pointer[NullablePointer[GErrorT]])
...
// use @g_socket_get_local_address[Pointer[GSocketAddressT]](socket': NullablePointer[GSocketT], error': Pointer[NullablePointer[GErrorT]])
...
// use @g_socket_get_remote_address[Pointer[GSocketAddressT]](socket': NullablePointer[GSocketT], error': Pointer[NullablePointer[GErrorT]])
