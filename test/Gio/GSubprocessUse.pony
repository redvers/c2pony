...
// Constructors
// use @g_subprocess_new[NullablePointer[GSubprocessT]](flags': U32, error': Pointer[NullablePointer[GErrorT]], argv0': Pointer[U8] tag, ...)
// use @g_subprocess_newv[NullablePointer[GSubprocessT]](argv': Pointer[Pointer[U8]] tag, flags': U32, error': Pointer[NullablePointer[GErrorT]])
...
// use @g_subprocess_communicate_async[None](subprocess': NullablePointer[GSubprocessT], stdin_buf': NullablePointer[GBytesT], cancellable': NullablePointer[GCancellableT], callback': GAsyncReadyCallback, user_data': Pointer[None] tag)
...
// use @g_subprocess_communicate_utf8_async[None](subprocess': NullablePointer[GSubprocessT], stdin_buf': Pointer[U8] tag, cancellable': NullablePointer[GCancellableT], callback': GAsyncReadyCallback, user_data': Pointer[None] tag)
...
// use @g_subprocess_get_identifier[Pointer[U8] tag](subprocess': NullablePointer[GSubprocessT])
...
// use @g_subprocess_get_stderr_pipe[NullablePointer[GInputStreamT]](subprocess': NullablePointer[GSubprocessT])
// use @g_subprocess_get_stdin_pipe[NullablePointer[GOutputStreamT]](subprocess': NullablePointer[GSubprocessT])
// use @g_subprocess_get_stdout_pipe[NullablePointer[GInputStreamT]](subprocess': NullablePointer[GSubprocessT])
...
// use @g_subprocess_wait_async[None](subprocess': NullablePointer[GSubprocessT], cancellable': NullablePointer[GCancellableT], callback': GAsyncReadyCallback, user_data': Pointer[None] tag)
...
// use @g_subprocess_wait_check_async[None](subprocess': NullablePointer[GSubprocessT], cancellable': NullablePointer[GCancellableT], callback': GAsyncReadyCallback, user_data': Pointer[None] tag)
