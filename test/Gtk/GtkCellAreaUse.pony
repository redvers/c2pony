...
// use @gtk_cell_area_copy_context[NullablePointer[GtkCellAreaContextT]](area': NullablePointer[GtkCellAreaT], context': NullablePointer[GtkCellAreaContextT])
...
// use @gtk_cell_area_get_edit_widget[NullablePointer[GtkCellEditableT]](area': NullablePointer[GtkCellAreaT])
// use @gtk_cell_area_get_edited_cell[NullablePointer[GtkCellRendererT]](area': NullablePointer[GtkCellAreaT])
// use @gtk_cell_area_get_focus_cell[NullablePointer[GtkCellRendererT]](area': NullablePointer[GtkCellAreaT])
// use @gtk_cell_area_get_focus_from_sibling[NullablePointer[GtkCellRendererT]](area': NullablePointer[GtkCellAreaT], renderer': NullablePointer[GtkCellRendererT])
// use @gtk_cell_area_get_focus_siblings[NullablePointer[GListT]](area': NullablePointer[GtkCellAreaT], renderer': NullablePointer[GtkCellRendererT])
