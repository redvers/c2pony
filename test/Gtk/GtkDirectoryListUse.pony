...
// use @gtk_directory_list_set_attributes[None](self': NullablePointer[GtkDirectoryListT], attributes': Pointer[U8] tag)
// use @gtk_directory_list_set_file[None](self': NullablePointer[GtkDirectoryListT], file': NullablePointer[GFileT])
// use @gtk_directory_list_set_io_priority[None](self': NullablePointer[GtkDirectoryListT], io_priority': I32)
// use @gtk_directory_list_set_monitored[None](self': NullablePointer[GtkDirectoryListT], monitored': I32)
