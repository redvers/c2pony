...
// Constructors
// use @gtk_list_view_new[Pointer[GtkWidgetT]](model': NullablePointer[GtkSelectionModelT], factory': NullablePointer[GtkListItemFactoryT])

// Methods
// use @gtk_list_view_get_enable_rubberband[I32](self': NullablePointer[GtkListViewT])
// use @gtk_list_view_get_factory[Pointer[GtkListItemFactoryT]](self': NullablePointer[GtkListViewT])
// use @gtk_list_view_get_model[Pointer[GtkSelectionModelT]](self': NullablePointer[GtkListViewT])
