...
// Constructors
// use @gtk_event_controller_key_new[Pointer[GtkEventControllerT]]()
...
// use @gtk_event_controller_key_get_im_context[Pointer[GtkIMContextT]](controller': NullablePointer[GtkEventControllerKeyT])
