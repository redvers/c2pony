...
// Constructors
// use @gtk_tree_expander_new[Pointer[GtkWidgetT]]()

// Methods
// use @gtk_tree_expander_get_child[Pointer[GtkWidgetT]](self': NullablePointer[GtkTreeExpanderT])
// use @gtk_tree_expander_get_indent_for_icon[I32](self': NullablePointer[GtkTreeExpanderT])
// use @gtk_tree_expander_get_item[Pointer[None]](self': NullablePointer[GtkTreeExpanderT])
// use @gtk_tree_expander_get_list_row[Pointer[GtkTreeListRowT]](self': NullablePointer[GtkTreeExpanderT])
