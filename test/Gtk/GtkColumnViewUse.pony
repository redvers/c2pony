...
// use @gtk_column_view_set_model[None](self': NullablePointer[GtkColumnViewT], model': NullablePointer[GtkSelectionModelT])
// use @gtk_column_view_set_reorderable[None](self': NullablePointer[GtkColumnViewT], reorderable': I32)
// use @gtk_column_view_set_show_column_separators[None](self': NullablePointer[GtkColumnViewT], show_column_separators': I32)
// use @gtk_column_view_set_show_row_separators[None](self': NullablePointer[GtkColumnViewT], show_row_separators': I32)
// use @gtk_column_view_set_single_click_activate[None](self': NullablePointer[GtkColumnViewT], single_click_activate': I32)
// use @gtk_column_view_sort_by_column[None](self': NullablePointer[GtkColumnViewT], column': NullablePointer[GtkColumnViewColumnT], direction': U32)
