...
// use @gtk_native_dialog_set_title[None](self': NullablePointer[GtkNativeDialogT], title': Pointer[U8] tag)
// use @gtk_native_dialog_set_transient_for[None](self': NullablePointer[GtkNativeDialogT], parent': NullablePointer[GtkWindowT])
// use @gtk_native_dialog_show[None](self': NullablePointer[GtkNativeDialogT])
