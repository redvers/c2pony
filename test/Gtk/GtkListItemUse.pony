...
// use @gtk_list_item_set_activatable[None](self': NullablePointer[GtkListItemT], activatable': I32)
// use @gtk_list_item_set_child[None](self': NullablePointer[GtkListItemT], child': NullablePointer[GtkWidgetT])
// use @gtk_list_item_set_selectable[None](self': NullablePointer[GtkListItemT], selectable': I32)
