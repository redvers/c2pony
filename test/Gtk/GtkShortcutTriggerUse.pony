...
// Constructors
// use @gtk_shortcut_trigger_parse_string[Pointer[GtkShortcutTriggerT]](string': Pointer[U8] tag)
...
// use @gtk_shortcut_trigger_to_label[Pointer[U8]](self': NullablePointer[GtkShortcutTriggerT], display': NullablePointer[GdkDisplayT])
// use @gtk_shortcut_trigger_to_string[Pointer[U8]](self': NullablePointer[GtkShortcutTriggerT])
