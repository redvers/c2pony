...
// use @gtk_combo_box_set_active[None](combo_box': NullablePointer[GtkComboBoxT], index_': I32)
// use @gtk_combo_box_set_active_id[I32](combo_box': NullablePointer[GtkComboBoxT], active_id': Pointer[U8] tag)
// use @gtk_combo_box_set_active_iter[None](combo_box': NullablePointer[GtkComboBoxT], iter': NullablePointer[GtkTreeIterT])
// use @gtk_combo_box_set_button_sensitivity[None](combo_box': NullablePointer[GtkComboBoxT], sensitivity': U32)
// use @gtk_combo_box_set_child[None](combo_box': NullablePointer[GtkComboBoxT], child': NullablePointer[GtkWidgetT])
// use @gtk_combo_box_set_entry_text_column[None](combo_box': NullablePointer[GtkComboBoxT], text_column': I32)
