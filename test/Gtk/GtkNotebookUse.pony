...
// Constructors
// use @gtk_notebook_new[Pointer[GtkWidgetT]]()
...
// use @gtk_notebook_get_action_widget[Pointer[GtkWidgetT]](notebook': NullablePointer[GtkNotebookT], pack_type': U32)
// use @gtk_notebook_get_current_page[I32](notebook': NullablePointer[GtkNotebookT])
// use @gtk_notebook_get_group_name[Pointer[U8]](notebook': NullablePointer[GtkNotebookT])
// use @gtk_notebook_get_menu_label[Pointer[GtkWidgetT]](notebook': NullablePointer[GtkNotebookT], child': NullablePointer[GtkWidgetT])
// use @gtk_notebook_get_menu_label_text[Pointer[U8]](notebook': NullablePointer[GtkNotebookT], child': NullablePointer[GtkWidgetT])
// use @gtk_notebook_get_n_pages[I32](notebook': NullablePointer[GtkNotebookT])
// use @gtk_notebook_get_nth_page[Pointer[GtkWidgetT]](notebook': NullablePointer[GtkNotebookT], page_num': I32)
// use @gtk_notebook_get_page[Pointer[GtkNotebookPageT]](notebook': NullablePointer[GtkNotebookT], child': NullablePointer[GtkWidgetT])
// use @gtk_notebook_get_pages[Pointer[GListModelT]](notebook': NullablePointer[GtkNotebookT])
...
// use @gtk_notebook_get_tab_label[Pointer[GtkWidgetT]](notebook': NullablePointer[GtkNotebookT], child': NullablePointer[GtkWidgetT])
// use @gtk_notebook_get_tab_label_text[Pointer[U8]](notebook': NullablePointer[GtkNotebookT], child': NullablePointer[GtkWidgetT])
