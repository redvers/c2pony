...
// Constructors
// use @gtk_label_new[Pointer[GtkWidgetT]](str': Pointer[U8] tag)
// use @gtk_label_new_with_mnemonic[Pointer[GtkWidgetT]](str': Pointer[U8] tag)

// Methods
// use @gtk_label_get_attributes[Pointer[PangoAttrListT]](self': NullablePointer[GtkLabelT])
// use @gtk_label_get_current_uri[Pointer[U8]](self': NullablePointer[GtkLabelT])
// use @gtk_label_get_ellipsize[U32](self': NullablePointer[GtkLabelT])
// use @gtk_label_get_extra_menu[Pointer[GMenuModelT]](self': NullablePointer[GtkLabelT])
// use @gtk_label_get_justify[U32](self': NullablePointer[GtkLabelT])
// use @gtk_label_get_label[Pointer[U8]](self': NullablePointer[GtkLabelT])
// use @gtk_label_get_layout[Pointer[PangoLayoutT]](self': NullablePointer[GtkLabelT])
...
// use @gtk_label_get_mnemonic_widget[Pointer[GtkWidgetT]](self': NullablePointer[GtkLabelT])
...
// use @gtk_label_get_text[Pointer[U8]](self': NullablePointer[GtkLabelT])
