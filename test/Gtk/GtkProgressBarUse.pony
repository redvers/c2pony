...
// use @gtk_progress_bar_get_fraction[F64](pbar': NullablePointer[GtkProgressBarT])
...
// use @gtk_progress_bar_set_inverted[None](pbar': NullablePointer[GtkProgressBarT], inverted': I32)
// use @gtk_progress_bar_set_pulse_step[None](pbar': NullablePointer[GtkProgressBarT], fraction': F64)
// use @gtk_progress_bar_set_show_text[None](pbar': NullablePointer[GtkProgressBarT], show_text': I32)
// use @gtk_progress_bar_set_text[None](pbar': NullablePointer[GtkProgressBarT], text': Pointer[U8] tag)
