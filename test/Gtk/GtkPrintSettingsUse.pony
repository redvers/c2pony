...
// Constructors
// use @gtk_print_settings_new[Pointer[GtkPrintSettingsT]]()
// use @gtk_print_settings_new_from_file[Pointer[GtkPrintSettingsT]](file_name': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])
// use @gtk_print_settings_new_from_gvariant[Pointer[GtkPrintSettingsT]](variant': NullablePointer[GVariantT])
// use @gtk_print_settings_new_from_key_file[Pointer[GtkPrintSettingsT]](key_file': NullablePointer[GKeyFileT], group_name': Pointer[U8] tag, error': Pointer[NullablePointer[GErrorT]])

// Methods
// use @gtk_print_settings_copy[Pointer[GtkPrintSettingsT]](other': NullablePointer[GtkPrintSettingsT])
// use @gtk_print_settings_get[Pointer[U8]](settings': NullablePointer[GtkPrintSettingsT], key': Pointer[U8] tag)
...
// use @gtk_print_settings_get_default_source[Pointer[U8]](settings': NullablePointer[GtkPrintSettingsT])
// use @gtk_print_settings_get_dither[Pointer[U8]](settings': NullablePointer[GtkPrintSettingsT])
...
// use @gtk_print_settings_get_finishings[Pointer[U8]](settings': NullablePointer[GtkPrintSettingsT])
...
// use @gtk_print_settings_get_media_type[Pointer[U8]](settings': NullablePointer[GtkPrintSettingsT])
...
// use @gtk_print_settings_get_output_bin[Pointer[U8]](settings': NullablePointer[GtkPrintSettingsT])
// use @gtk_print_settings_get_page_ranges[Pointer[GtkPageRangeT]](settings': NullablePointer[GtkPrintSettingsT], num_ranges': Pointer[I32] tag)
...
// use @gtk_print_settings_get_paper_size[Pointer[GtkPaperSizeT]](settings': NullablePointer[GtkPrintSettingsT])
...
// use @gtk_print_settings_get_printer[Pointer[U8]](settings': NullablePointer[GtkPrintSettingsT])
...
// use @gtk_print_settings_to_gvariant[Pointer[GVariantT]](settings': NullablePointer[GtkPrintSettingsT])
