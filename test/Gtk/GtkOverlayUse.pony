...
// use @gtk_overlay_set_child[None](overlay': NullablePointer[GtkOverlayT], child': NullablePointer[GtkWidgetT])
// use @gtk_overlay_set_clip_overlay[None](overlay': NullablePointer[GtkOverlayT], widget': NullablePointer[GtkWidgetT], clip_overlay': I32)
// use @gtk_overlay_set_measure_overlay[None](overlay': NullablePointer[GtkOverlayT], widget': NullablePointer[GtkWidgetT], measure': I32)
