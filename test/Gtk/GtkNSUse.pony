...
// use @gtk_accelerator_get_label_with_keycode[Pointer[U8] tag](display': NullablePointer[GdkDisplayT], accelerator_key': U32, keycode': U32, accelerator_mods': U32)
// use @gtk_accelerator_name[Pointer[U8] tag](accelerator_key': U32, accelerator_mods': U32)
// use @gtk_accelerator_name_with_keycode[Pointer[U8] tag](display': NullablePointer[GdkDisplayT], accelerator_key': U32, keycode': U32, accelerator_mods': U32)
...
// use @gtk_get_default_language[NullablePointer[PangoLanguageT]]()
...
// use @gtk_param_spec_expression[NullablePointer[GParamSpecT]](name': Pointer[U8] tag, nick': Pointer[U8] tag, blurb': Pointer[U8] tag, flags': I32)
// use @gtk_print_run_page_setup_dialog[NullablePointer[GtkPageSetupT]](parent': NullablePointer[GtkWindowT], page_setup': NullablePointer[GtkPageSetupT], settings': NullablePointer[GtkPrintSettingsT])
// use @gtk_print_run_page_setup_dialog_async[None](parent': NullablePointer[GtkWindowT], page_setup': NullablePointer[GtkPageSetupT], settings': NullablePointer[GtkPrintSettingsT], done_cb': GtkPageSetupDoneFunc, data': Pointer[None] tag)
...
// use @gtk_show_uri_full[None](parent': NullablePointer[GtkWindowT], uri': Pointer[U8] tag, timestamp': U32, cancellable': NullablePointer[GCancellableT], callback': GAsyncReadyCallback, user_data': Pointer[None] tag)
...
// use @gtk_test_accessible_check_property[Pointer[U8] tag](accessible': NullablePointer[GtkAccessibleT], property': U32, ...)
// use @gtk_test_accessible_check_relation[Pointer[U8] tag](accessible': NullablePointer[GtkAccessibleT], relation': U32, ...)
// use @gtk_test_accessible_check_state[Pointer[U8] tag](accessible': NullablePointer[GtkAccessibleT], state': U32, ...)
...
// use @gtk_tree_create_row_drag_content[NullablePointer[GdkContentProviderT]](tree_model': NullablePointer[GtkTreeModelT], path': NullablePointer[GtkTreePathT])
...
// use @gtk_value_dup_expression[NullablePointer[GtkExpressionT]](value': NullablePointer[GValueT])
// use @gtk_value_get_expression[NullablePointer[GtkExpressionT]](value': NullablePointer[GValueT])
