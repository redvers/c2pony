...
// use @gtk_action_bar_remove[None](action_bar': NullablePointer[GtkActionBarT], child': NullablePointer[GtkWidgetT])
// use @gtk_action_bar_set_center_widget[None](action_bar': NullablePointer[GtkActionBarT], center_widget': NullablePointer[GtkWidgetT])
// use @gtk_action_bar_set_revealed[None](action_bar': NullablePointer[GtkActionBarT], revealed': I32)
