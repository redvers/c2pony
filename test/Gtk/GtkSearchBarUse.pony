...
// use @gtk_search_bar_set_key_capture_widget[None](bar': NullablePointer[GtkSearchBarT], widget': NullablePointer[GtkWidgetT])
// use @gtk_search_bar_set_search_mode[None](bar': NullablePointer[GtkSearchBarT], search_mode': I32)
// use @gtk_search_bar_set_show_close_button[None](bar': NullablePointer[GtkSearchBarT], visible': I32)
