...
// use @gtk_entry_buffer_emit_deleted_text[None](buffer': NullablePointer[GtkEntryBufferT], position': U32, n_chars': U32)
// use @gtk_entry_buffer_emit_inserted_text[None](buffer': NullablePointer[GtkEntryBufferT], position': U32, chars': Pointer[U8] tag, n_chars': U32)
