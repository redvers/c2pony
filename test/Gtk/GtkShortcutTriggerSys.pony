...
primitive GtkShortcutTriggerSys
// Static Functions
...
// Methods
/* 
fun compare(trigger1': Pointer[None] tag, trigger2': Pointer[None] tag): I32 =>
    @gtk_shortcut_trigger_compare(trigger1', trigger2')
*/
/* 
fun equal(trigger1': Pointer[None] tag, trigger2': Pointer[None] tag): I32 =>
    @gtk_shortcut_trigger_equal(trigger1', trigger2')
*/
/* 
fun hash(trigger': Pointer[None] tag): U32 =>
