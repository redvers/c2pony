...
// use @gtk_picture_set_filename[None](self': NullablePointer[GtkPictureT], filename': Pointer[U8] tag)
// use @gtk_picture_set_keep_aspect_ratio[None](self': NullablePointer[GtkPictureT], keep_aspect_ratio': I32)
// use @gtk_picture_set_paintable[None](self': NullablePointer[GtkPictureT], paintable': NullablePointer[GdkPaintableT])
// use @gtk_picture_set_pixbuf[None](self': NullablePointer[GtkPictureT], pixbuf': NullablePointer[GdkPixbufT])
// use @gtk_picture_set_resource[None](self': NullablePointer[GtkPictureT], resource_path': Pointer[U8] tag)
