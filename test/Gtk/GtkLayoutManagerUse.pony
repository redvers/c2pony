...
// use @gtk_layout_manager_get_layout_child[Pointer[GtkLayoutChildT]](manager': NullablePointer[GtkLayoutManagerT], child': NullablePointer[GtkWidgetT])
// use @gtk_layout_manager_get_request_mode[U32](manager': NullablePointer[GtkLayoutManagerT])
// use @gtk_layout_manager_get_widget[Pointer[GtkWidgetT]](manager': NullablePointer[GtkLayoutManagerT])
