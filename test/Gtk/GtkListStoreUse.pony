...
// Constructors
// use @gtk_list_store_new[NullablePointer[GtkListStoreT]](n_columns': I32, ...)
// use @gtk_list_store_newv[NullablePointer[GtkListStoreT]](n_columns': I32, types': Pointer[U64] tag)
