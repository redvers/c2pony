...
// use @gtk_stack_page_set_name[None](self': NullablePointer[GtkStackPageT], setting': Pointer[U8] tag)
// use @gtk_stack_page_set_needs_attention[None](self': NullablePointer[GtkStackPageT], setting': I32)
// use @gtk_stack_page_set_title[None](self': NullablePointer[GtkStackPageT], setting': Pointer[U8] tag)
// use @gtk_stack_page_set_use_underline[None](self': NullablePointer[GtkStackPageT], setting': I32)
// use @gtk_stack_page_set_visible[None](self': NullablePointer[GtkStackPageT], visible': I32)
