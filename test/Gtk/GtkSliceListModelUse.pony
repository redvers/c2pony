...
// Constructors
// use @gtk_slice_list_model_new[Pointer[GtkSliceListModelT]](model': NullablePointer[GListModelT], offset': U32, size': U32)

// Methods
// use @gtk_slice_list_model_get_model[Pointer[GListModelT]](self': NullablePointer[GtkSliceListModelT])
