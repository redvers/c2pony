...
// use @gtk_list_box_row_set_activatable[None](row': NullablePointer[GtkListBoxRowT], activatable': I32)
// use @gtk_list_box_row_set_child[None](row': NullablePointer[GtkListBoxRowT], child': NullablePointer[GtkWidgetT])
// use @gtk_list_box_row_set_header[None](row': NullablePointer[GtkListBoxRowT], header': NullablePointer[GtkWidgetT])
// use @gtk_list_box_row_set_selectable[None](row': NullablePointer[GtkListBoxRowT], selectable': I32)
